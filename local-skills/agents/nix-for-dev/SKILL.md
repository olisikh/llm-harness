...
- [nix-haskell](https://github.com/srid/emanote/blob/master/.agents/skills/nix-haskell/SKILL.md) — flake-parts + haskell-template variant (when ergonomics > cold start)
