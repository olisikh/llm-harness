...
2. Run:
   ```bash
   /Users/olisikh/.agents/skills/transcribe/scripts/read-aloud.sh --text-file /absolute/path/to/text.txt --json
   ```
...
```bash
/Users/olisikh/.agents/skills/transcribe/scripts/read-aloud.sh --text "Hallo wereld" --json
```

## Useful overrides
- Force locale:
  ```bash
  /Users/olisikh/.agents/skills/transcribe/scripts/read-aloud.sh --text-file /tmp/input.txt --locale nl-BE --json
  ```
- Force a specific voice:
  ```bash
  /Users/olisikh/.agents/skills/transcribe/scripts/read-aloud.sh --text-file /tmp/input.txt --voice nl-NL-ColetteNeural --json
  ```
- Prefer male voice:
  ```bash
  /Users/olisikh/.agents/skills/transcribe/scripts/read-aloud.sh --text-file /tmp/input.txt --gender male --json
  ```
- Dry-run language/voice selection without rendering:
  ```bash
  /Users/olisikh/.agents/skills/transcribe/scripts/read-aloud.sh --text-file /tmp/input.txt --dry-run --json
  ```
